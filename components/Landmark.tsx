  ...
  return (
    <section className="section warm">
      <div className="shell split">
        ...
        <div className="imageFrame"><Image src="/images/hero.jpg" alt="영종 디에트르 라 메르 야경 투시도" width={905} height={965} sizes="(max-width: 900px) 100vw, 50vw" className="landmarkImage" /></div>
      </div>
    </section>
  );
}
